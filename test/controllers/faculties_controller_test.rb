...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { nombre_facultad: @faculty.nombre_facultad } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { nombre_facultad: @faculty.nombre_facultad } }
