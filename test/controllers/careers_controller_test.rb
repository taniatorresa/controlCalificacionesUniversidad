...
class CareersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post careers_url, params: { career: { nombre_abbr: @career.nombre_abbr, nombre_carrera: @career.nombre_carrera } }
    end
  ...
  test "should update career" do
    patch career_url(@career), params: { career: { nombre_abbr: @career.nombre_abbr, nombre_carrera: @career.nombre_carrera } }
